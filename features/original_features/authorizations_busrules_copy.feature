...
Feature: Authorizations - Busrules
	...
	When in the "Home" page I click on "Authorizations/Medical Management"
		...
		And the test pauses for "10" seconds
		And in the "Certification" page I enter "00008410501" into the "Member Number" field
	...
	Examples:
	 ...
	 | IP								| M						| 02/18/2014			| 436							| 932406				| 902619				| 999999							| A1		|
	 | IP								| M						| 02/18/2014			| 436							| 932406				| 902619				| 999999							| 9A		|
	 | IP								| M						| 02/18/2014			| 436							| 932406				| 902619				| 999999							| D6		|
	 | IP								| M						| 02/18/2014			| 436							| 932406				| 902619				| 999999							| 9G		|
	...
	When the test pauses for "30" seconds
		And in the "Functions Menu" page I click on "Authorized Svcs"
		And the test pauses for "30" seconds
		And in the "Authorized Services" page I enter "01122014" into the "Dates 1 Requested" image
		And in the "Authorized Services" page I enter "1" into the "How Many Authorized" image
		And in the "Authorized Services" page I enter "902619" into the "Ref Prov Number 1" image
	...
	Given in the "Functions Menu" page I click on "Hospital Svcs"
		And the test pauses for "30" seconds
		And in the "Hospital Services" page I enter "01122014" into the "Est Admit" image
		And in the "Hospital Services" page I enter "932406" into the "Facility Number" image
		And in the "Hospital Services" page I enter "902619" into the "Att Prov Number 1" image
		And in the "Hospital Services" page I enter "777777" into the "Admit ID Number" image
		And in the "Hospital Services" page I enter "932340" into the "Ref Prov Number 1" image
		And in the "Hospital Services" page I enter "1" into the "Auth Days" image
		And in the "Hospital Services" page I enter "1" into the "Req Days" image
		And in the "Hospital Services" page I enter "03" into the "Admit Type" image
	...
	Examples:
	 | Authorization Type 				| Claim Type Value		| Est Admit Date		| Diagnosis Code				| Facility Number		| Provider Number		| Provider Number Default			| EX Codes	|
	 | IP								| M						| 02/18/2014			| 436							| 932406				| 902619				| 999999							| A1		|
	 | IP								| M						| 02/18/2014			| 436							| 932406				| 902619				| 999999							| D0		|
	...
	#| AF								| M						| 01/30/2014			| 401							| 932406				| 921534				| 999999							|
	...
	#| IP								| M						| 01/01/2013			| 458.9							| 901451				| 926335				| 999999							|
	 | IP								| M						| 02/18/2014			| 436							| 932406				| 902619				| 999999							|
	...
	When in the "Home" page I click on "Authorizations/Medical Management"
		...
		And in the "Hospital Services" page I enter "932406" into the "Facility Number" image
		And in the "Hospital Services" page I enter "902619" into the "Att Prov Number 1" image
		And in the "Hospital Services" page I enter "902619" into the "Admit ID Number" image
		And in the "Hospital Services" page I enter "902619" into the "Ref Prov Number 1" image
		And in the "Hospital Services" page I enter "1" into the "Auth Days" image
	...
	When in the "Home" page I click on "Authorizations/Medical Management"
		...
		And in the "Certification" page I enter "140521000468" into the "Auth Number" field
		And I press "Control + S"
	...
	When in the "Home" page I click on "Authorizations/Medical Management"
		...
		And in the "Functions Menu" page I click on "Hospital Svcs"
		And the test pauses for "30" seconds
		And in the "Hospital Services" page I enter "02/18/2014" into the "Est Admit" image
		And in the "Hospital Services" page I enter "932406" into the "Facility Number" image
		And in the "Hospital Services" page I enter "902619" into the "Att Prov Number 1" image
...
Given I sign in to the application
	...
	When in the "Home" page I click on "Authorizations/Medical Management"
		...
		And the test pauses for "30" seconds
		And in the "Progress Notes" page I enter "This is a test progress note 2" into the "Text Field Selected" image
		And the test pauses for "10" seconds
		And I press "Control + S"
		And the test pauses for "10" seconds
		And in the "Progress Notes" page I click on the "Append" image
		And the test pauses for "30" seconds
		And in the "Progress Notes" page I enter "This is a test progress note 3" into the "Text Field Selected" image
		And the test pauses for "10" seconds
		And I press "Control + S"
		And the test pauses for "10" seconds
	...
	Examples:
	  ...
	  | IP									| H								| 01/30/2014			| 1710    							| 932406				| 921534					| 
	  | OP									| H								| 01/30/2014			| 1710    							| 932406				| 921534					| 
	  | SN									| H								| 01/30/2014			| 1710    							| 932406				| 921534					| 
	  | OB									| H								| 01/30/2014			| 1710    							| 932406				| 921534					| 
	...
	Examples:
	  | Authorization Type 					| Claim Type Value				| Est Admit Date		| Diagnosis Code					| Facility Number		| Provider Number			| 
	  | OP									| M								| 01/30/2014			| 1710								| 932406				| 921534					| 
	  | SN									| M								| 01/30/2014			| 1710								| 932406				| 921534					| 