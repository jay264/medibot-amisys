Feature: Rerun Essette Extract EssetteDailyExtractReport-Outpatient(NEWADD)-2017-09-28
	As an auth entering person
	I want the ability to add all types of authorizations
	so that I know that information is entered correctly

Scenario Outline: RerunEssetteDailyExtractReport-Outpatient(NEWADD)-2017-09-28
