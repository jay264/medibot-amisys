Feature: RUN2 Process Essette Extract EssetteDailyExtractReport-Outpatient(NEWADD)-2018-01-24
	As an auth entering person
	I want the ability to add all types of authorizations
	so that I know that information is entered correctly

Scenario Outline: RUN2_EssetteDailyExtractReport-Outpatient(NEWADD)-2018-01-24
