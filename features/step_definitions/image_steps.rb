...
determine_ex_code(essette_sub_class, status, status_reason)
  screen_image = "#{$image_directory}" + "#{page}" + "\\" + "#{element}" + ".PNG"
  begin
    @screen.wait "#{screen_image}", 30
    if @screen.exists "#{screen_image}"
  ...
  ex_code = "WS"
    ...
    ex_code = "BD"
      ...
      ex_code = "BD"
        ...
        ex_code = "A1"
        elsif essette_sub_class == "Skilled Nursing Facility" && status == "Denied" && status_reason == "Administrative Denial"
          ex_code = "9A"
          ...
          ex_code = "WS"
            ...
            ex_code = "BD"
          elsif essette_sub_class == "Skilled Nursing Facility" && status == "Approved Skilled" && status_reason == "SNF"
            ex_code = "BD"
          elsif essette_sub_class == "Skilled Nursing Facility" && status == "Approved Skilled" && status_reason == "Pending Admission"
            ex_code = "9A"
          elsif essette_sub_class == "Skilled Nursing Facility" && status == "Approved Skilled" && status_reason == "Secondary Only"
            ex_code = "BD"
          elsif essette_sub_class == "Skilled Nursing Facility" && status == "Approved Skilled" && status_reason == "Medical Criteria Met"
            ex_code = "BD"
          elsif essette_sub_class == "Skilled Nursing Facility" && status == "Denied Skilled - Pay Unskilled" && status_reason == ""
            ex_code = "NF"
          elsif essette_sub_class == "Skilled Nursing Facility" && status == "Denied Skilled - Pay Unskilled" && status_reason == "Denied Skilled - Pay Unskilled"
            ex_code = "NF"
          elsif essette_sub_class == "Denied Skilled - Pay Unskilled" && status == "Approved" && status_reason == "Denied Skilled - Pay Unskilled"
            ex_code = "NF"
          end
  screen_image = "#{$image_directory}" + "#{page}" + "\\" + "#{element}" + ".PNG"
  begin
...
def determine_ex_code (essette_sub_class, status, status_reason)
  if essette_sub_class == "Inpatient" && status == "Approved" && status_reason == "ACO"
    ...
    ex_code = "9A"
  elsif essette_sub_class == "Inpatient" && status == "Approved" && status_reason == "ACO - Pulmonary"
    ex_code = "NG"
  elsif essette_sub_class == "Inpatient" && status == "Approved" && status_reason == "ACO - Cardiology"
    ex_code = "NH"
  elsif essette_sub_class == "Inpatient" && status == "Approved" && status_reason == "ACO - Atrial Fib"
    ex_code = "NI"
  elsif essette_sub_class == "Inpatient" && status == "Approved" && status_reason == "ACO - CHF"
    ex_code = "NJ"
  elsif essette_sub_class == "Inpatient" && status == "Approved" && status_reason == "ACO - Carotid"
    ex_code = "NK"
    ...
    ex_code = "A6"
  elsif essette_sub_class == "Inpatient" && status == "Denied" && status_reason == "Administrative Denial"
    ex_code = "9A"
    ...
    ex_code = "BC"
  elsif essette_sub_class == "IP Behavioral Health" && status == "Denied" && status_reason == "Administrative Denial"
    ex_code = "9A"
    ...
    ex_code = "BC"
  elsif essette_sub_class == "IP Substance Abuse" && status == "Denied" && status_reason == "Administrative Denial"
    ex_code = "9A"
    ...
    ex_code = "BC"
  elsif essette_sub_class == "Long Term Acute Care Hospital" && status == "Denied" && status_reason == "Administrative Denial"
    ex_code = "9A"
    ...
    ex_code = "WS"
  elsif essette_sub_class == "Observation" && status == "Denied" && status_reason == "Administrative Denial"
    ex_code = "9A"
    ...
    ex_code = "WS"
  elsif essette_sub_class == "Transplant" && status == "Denied" && status_reason == "Administrative Denial"
    ex_code = "9A"
    ...
    ex_code = "A6"
  elsif essette_sub_class == "Clinical Trial" && status == "Approved" && status_reason == "Administrative Denial"
    ex_code = "9A"
    ...
    ex_code = "9A"
  elsif essette_sub_class == "DME" && status == "Approved" && status_reason == "Services Not Available In-Network"
    ex_code = "A7"
    ...
    ex_code = "A7"
  elsif essette_sub_class == "Out of Network Services" && status == "Approved" && status_reason == "Transplant Evaluation"
    ex_code = "A7"
    ...
    ex_code = "A1"
  elsif essette_sub_class == "Outpatient Surgery/Procedure" && status == "Approved" && status_reason == "Services Not Available In-Network"
    ex_code = "A7"
    ...
    ex_code = "A1"
  elsif essette_sub_class == "Cardiology (HH)" && status == "Denied" && status_reason == "Administrative Denial"
    ex_code = "9A"
    ...
    ex_code = "WS"
  elsif essette_sub_class == "Genetic Testing" && status == "Denied" && status_reason == "Administrative Denial"
    ex_code = "9A"
    ...
    ex_code = "WS"
  elsif essette_sub_class == "Hyperbaric Oxygen" && status == "Denied" && status_reason == "Administrative Denial"
    ex_code = "9A"
    ...
    ex_code = "WS"
  elsif essette_sub_class == "Integrated Oncology (HH)" && status == "Denied" && status_reason == "Administrative Denial"
    ex_code = "9A"
    ...
    ex_code = "WS"
  elsif essette_sub_class == "OP Behavioral Health" && status == "Denied" && status_reason == "Administrative Denial"
    ex_code = "9A"
    ...
    ex_code = "WS"
  elsif essette_sub_class == "OP Substance Abuse" && status == "Denied" && status_reason == "Administrative Denial"
    ex_code = "9A"
    ...
    ex_code = "WS"
  elsif essette_sub_class == "Out of Network Services" && status == "Denied" && status_reason == "Administrative Denial"
    ex_code = "9A"
    ...
    ex_code = "WL"
  elsif essette_sub_class == "Out of Network Services" && status == "Denied" && status_reason == "Not a Covered Benefit (PA)"
    ex_code = "WL"
    ...
    ex_code = "WS"
  elsif essette_sub_class == "Part B Therapy" && status == "Denied" && status_reason == "Administrative Denial"
    ex_code = "9A"
    ...
    ex_code = "WS"
  elsif essette_sub_class == "Predetermination Request" && status == "Denied" && status_reason == "Administrative Denial"
    ex_code = "9A"
    ...
    ex_code = "WS"
  elsif essette_sub_class == "Radiology (HH)" && status == "Denied" && status_reason == "Administrative Denial"
    ex_code = "9A"
    ...
    ex_code = "WS"
  elsif essette_sub_class == "Transplant Eval" && status == "Denied" && status_reason == "Administrative Denial"
    ex_code = "9A"
